...
* [Què és](peti_docum.md#que-es)
* [Com s’hi accedeix](peti_docum.md#com-shi-accedeix)
* [Quines operacions es poden fer](peti_docum.md#quines-operacions-es-poden-fer)

  + [Traspàs de custòdia entre centres Esfer@](peti_docum.md#traspas-de-custodia-entre-centres-esfer)

    - [Actuacions prèvies](peti_docum.md#actuacions-previes)
    - [Fer una petició de documentació](peti_docum.md#fer-una-peticio-de-documentacio)
    - [Respondre una petició de documentació](peti_docum.md#respondre-una-peticio-de-documentacio)
    - [Rebre la documentació](peti_docum.md#rebre-la-documentacio)
  + [Traspàs de documentació d'un centre Esfer@ a un centre NO Esfer@](peti_docum.md#traspas-de-documentacio-dun-centre-esfer-a-un-centre-no-esfer)
  + [Traspàs de documentació d'un centre NO Esfer@ a un centre Esfer@](peti_docum.md#traspas-de-documentacio-dun-centre-no-esfer-a-un-centre-esfer)
...
![](../../_media/esfera/mgac/gadmin/ima0.png)
...
![](../../_media/esfera/mgac/gadmin/tras_cus_00.png)*Imatge 1 - Accés al menú Petició de documentació*
...
1. El centre B comprova que a la FDA, [\*\*Dades d’accés i finalització\*\*](../../mgad1/gest_adm/peticio_documentacio/peticio_doc.md#dades-dacces-i-finalitzacio) de l’Àmbit acadèmic, hi consta el nom del centre que té la custòdia.
...
![](../../_media/esfera/mgac/gadmin/fil_traspas_docu1.png)

#### Actuacions prèvies

Abans d'iniciar el procés del traspàs de custòdia són imprescindibles dues accions:

1. El centre A ha d'**[arxivar l'expedient l'alumne](arx_expe.md)**, després d'haver-lo donat de baixa.
2. El centre B ha de **completar les dades de procedència** a la fitxa de l'alumne, després d'haver-lo matriculat.

![](../../_media/esfera/mgac/gadmin/tras_cus_01.png)*Imatge 2 - Completar les dades de procedència* 
  
![](../../_media/esfera/mgac/btn-pujar.gif)![](../../_media/esfera/mgac/pujar0.png)

---

![](../../_media/esfera/mgac/gadmin/fil_traspas_docu2.png)
...
![](../../_media/esfera/mgac/gadmin/tras_cus_02.png)*Imatge 3 - Accés al menú Petició de documentació*
...
![](../../_media/esfera/mgac/gadmin/ima1.png)*Imatge 4 - Cerca dels alumnes*
...
![](../../_media/esfera/mgac/gadmin/ima2.png)*Imatge 5 - Selecció dels alumnes* 
...
![](../../_media/esfera/mgac/gadmin/ima3.png)*Imatge 6 - Signar la petició de documentació* 
  
  
La petició de documentació quedarà **Pendent de resposta**.
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_06.png)*Imatge 7 - Petició pendent de resposta* 
...
![](../../_media/esfera/mgac/gadmin/fil_traspas_docu3.png)
...
![](../../_media/esfera/mgac/gadmin/tras_cus_07.png)*Imatge 8 - Accés a Resposta de peticions de documentació* 
...
![](../../_media/esfera/mgac/gadmin/tras_cus_08.png)*Imatge 9 - Cerca de peticions* 
  
  
Opcionalment podeu consultar el **detall** de la petició clicant la icona de detall.
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_09.png)*Imatge 10 - Detall de la petició* 
...
![](../../_media/esfera/mgac/gadmin/tras_cus_10.png)*Imatge 11 - Signa la tramesa* 
  
  
La petició quedarà **Pendent de signar**:
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_10a.png)*Imatge 12 - Petició pendent de signar* 
...
![](../../_media/esfera/mgac/gadmin/tras_cus_11.png)*Imatge 13 - Traspassa la documentació* 
  
  
El traspàs estarà pendent de l'acceptació del centre peticionari (Centre B).
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_12.png)*Imatge 14 - Documentació pendent d'acceptació* 
...
![](../../_media/esfera/mgac/gadmin/tras_cus_17.png)*Imatge 15 - Tanca per error* 
  
  
El centre peticionari veurà que la seva petició ha estat tancada:
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_18.png)*Imatge 16 - Petició Tancada per error*
...
![](../../_media/esfera/mgac/gadmin/fil_traspas_docu4.png)
...
![](../../_media/esfera/mgac/gadmin/tras_cus_13.png)*Imatge 17 - Accés a recepció de documentació* 
  
  
**Cercar** la petició de la qual s'ha rebut la custòdia:
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_14.png)*Imatge 18 - Cerca petició* 
...
![](../../_media/esfera/mgac/comprovahist.png)*Imatge 19 - Accés a Comprovar els documents amb la informació acadèmica rebuda*
...
![](../../_media/esfera/mgac/gadmin/tras_cus_14a.png)*Imatge 20 - Cerca petició revisada* 
  
  
Prémer el botó [**Més accions**] i clicar l'opció **Resposta acceptada**.
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_15.png)*Imatge 21 - Resposta acceptada* 
...
![](../../_media/esfera/mgac/gadmin/tras_cus_16.png)*Imatge 22 - Resposta no adient*
  
  
Amb aquesta acció la petició ha quedat tancada. El centre peticionari (centre B) haurà d'iniciar una **nova petició**.
  
  
![](../../_media/esfera/mgac/gadmin/tras_cus_19.png)*Imatge 23 - Nova petició d'una amb resposta no adient*
