...
Des d'aquest opció del submòdul **Matrícula d'alumnes del centre per continuïtat** del mòdul **Matrícula i fitxa de l'alumne/a** es matriculen els alumnes que tenen una matrícula activa al centre.
...
S'ha d'escollir l'opció **Matrícula d'alumnes del centre per continuïtat** del mòdul **Matrícula i fitxa de l'alumne/a**.
  
  
![](../../_media/esfera/mgac/mat/mat_cont.png)*Imatge 1 - Accés al menú Matrícula d'alumnes del centre per continuïtat*
![](../../_media/esfera/mgac/btn-pujar.gif) ![](../../_media/esfera/mgac/pujar0.png)
...
* cursen un ensenyament que no té avaluació final normativa i, per tant, no disposen d'actes d'avaluació (per exemple, educació infantil). En aquest cas es mostren els alumnes del nivell immediatament anterior al seleccionat al formulari, per seleccionar els que passin de curs, i també es mostren els alumnes del nivell seleccionat al formulari, per seleccionar els que no passin de curs. En aquests casos la selecció entre els alumnes que passin o no passin de curs s'efectua directament en aquest punt del sistema.

Es mostra la llista d'alumnes que compleixen les condicions de cerca explicades anteriorment.  
Si es clica a la icona ![](../../_media/esfera/mgac/editar.png) es dona pas al formulari per fer el procés de matrícula.  
Ara bé, els alumnes que se seleccionin fent un clic a la caselles de verificació, s'inclouran en un lot de matrícula que es farà efectiva quan es cliqui al botó "Lot de matrícula".
...
* Les dades identificatives són les mateixes de la "Fitxa de l'alumne/a", a l'àmbit acadèmic, i a la pestanya "Dades identificatives", però només de lectura. Aquestes dades no es podran modificar fins després de finalitzar el procés de matrícula.
...
També hi ha els botons ![](../../_media/esfera/mgac/mat/resguard.png) i ![](../../_media/esfera/mgac/mat/resguard_declaracio.png), que només estan actius si s'ha formalitzat la matrícula:

* **Resguard de la matrícula**: És el resguard conforme l'alumne s'ha matriculat al centre d'un ensenyament, nivell, règim i torn. A més, conté les dades curriculars de la matrícula.
* **Resguard de la matrícula i declaració**: S'imprimeix el resguard de la matrícula i també una declaració conforme s'ha llegit la carta de compromís amb el centre, i que la família ha de signar.
...
* [Dades identificatives](../fda/fda-ap-identificacio.md)
* [Dades dels tutors](../fda/fda-ap-tutors.md)
* [Dades dels serveis del menjador i transport](../fda/fda-ap-serveis.md)
* [Situacions rellevants de l'alumne/a](../fda/fda-ap-sit_rellevants.md)
* [Camps lliures](../fda/fda-ap-camps_lliures.md)
* [Contactes](../fda/fda-ap-contactes.md)
...
Al confirmar l'acció anterior, l'aplicació mostra un missatge informatiu en què es rebrà un correu electrònic quan hagi finalitzat el procés i que també pot consultar l'estat de matriculació a l'opció del menú **Resultats dels lots de matrícula** del mòdul **Matrícula i fitxa de l'alumne/a**.
