...
![](../../_media/esfera/mgac/personal/personal_01.png)*Imatge 1 - Accés a personal pendent de nomenar*
...
* [Consultar els professors pendents de nomenar](per_pn.md#consultar-els-professors-pendents-de-nomenar)
* [Afegir un professor pendent de nomenar](per_pn.md#afegir-un-professor-pendent-de-nomenar)
* [Eliminar un professor pendent de nomenar](per_pn.md#eliminar-un-professor-pendent-de-nomenar)
...
* **Acció**: Icona ![](../../_media/esfera/mgac/i_accedeix.png)que serveix per accedir a més informació del professor o professora pendent de nomenar.

![](../../_media/esfera/mgac/personal/personal_03.png)*Imatge 2 - Relació de personal pendent de nomenar*

#### Afegir un professor pendent de nomenar

Cal prémer la icona ![](../../_media/esfera/mgac/a_afegeix_b.png) des de la llista de professors pendents de nomenar.
  
L'aplicació mostra una pantalla emergent amb un formulari on cal emplenar les dades següents:

* Nom

Si es clica a ![](../../_media/esfera/mgac/desa.png), i no hi ha registrat un altre professor o professora pendent de nomenar amb aquest nom, se'n crea un de nou. En cas contrari, es mostra un missatge en què s'informa de l'error.
  
  
![](../../_media/esfera/mgac/personal/personal_02.png)*Imatge 3 - Afegir una persona pendent de nomenar*

#### Eliminar un professor pendent de nomenar

Cal seleccionar, de la llista de professors pendents de nomenar, el que es vol esborrar i prémer el botó ![](../../_media/esfera/mgac/esborra.png). L'aplicació comprova, abans d'esborrar-lo, que el professor o professora seleccionat no estigui assignat a cap grup classe, ni per impartir-hi docència ni per ser-ne el tutor o tutora, i també comprova que no hi hagin dades de dedicació enregistrades.

##### Substituir-ne un

Cal clicar a la icona ![](../../_media/esfera/mgac/i_accedeix.png) que hi ha a la fila del professor o professora pendent de nomenar que es vol substituir.
  
A continuació es mostra una pantalla amb les dades següents:
  
  
![](../../_media/esfera/mgac/personal/personal_04.png)*Imatge 4 - Substitueix a...*
...
En prémer el botó ![](../../_media/esfera/mgac/desa.png), l'aplicació en demana la confirmació.  
