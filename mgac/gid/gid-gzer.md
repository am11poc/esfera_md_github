...
* [Què són](gid-gzer.md#que-son)
* [Com s’hi accedeix](gid-gzer.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](gid-gzer.md#quines-operacions-shi-poden-fer)

  + [Crear un grup ZER](gid-gzer.md#crear-un-grup-zer)
  + [Modificar un grup ZER](gid-gzer.md#modificar-un-grup-zer)
  + [Esborrar un grup ZER](gid-gzer.md#esborrar-un-grup-zer)
...
![](../../_media/esfera/mgac/gid/gzer_06.png)*Imatge 1 - Llista de grups ZER* 
...
![](../../_media/esfera/mgac/gid/gzer_01.png)*Imatge 2 - Accés als grups ZER des d'una ZER*
  
  
![](../../_media/esfera/mgac/gid/gzer_05.png)*Imatge 2 - Accés als grups ZER des d'una escola de la ZER*
...
* [Crear un grup ZER](gid-gzer.md#crear-un-grup-zer) - **Només des de la ZER**. Permet crear nous grups ZER
* [Modificar un grup ZER](gid-gzer.md#modificar-un-grup-zer) - Per veure la composició del grup, és a dir, la relació d'alumnes i personal i modificar-lo, si és el cas.
...
* [Esborrar un grup ZER](gid-gzer.md#esborrar-un-grup-zer) - **Només des de la ZER** El programa permet esborrar un grup ZER sempre que no tingui alumnes, personal ni responsable.
...
* [Identificar el grup](gid-gzer.md#identificar-el-grup)
* [Afegir/treure alumnes del grup](gid-gzer.md#afegirtreure-alumnes-del-grup)
* [Afegir/treure personal al grup](gid-gzer.md#afegirtreure-personal-al-grup)

En primer lloc, s'ha de clicar el botó ![](../../_media/esfera/mgac/afegeix.png). Aquesta opció només està disponible per a la ZER.
...
![](../../_media/esfera/mgac/gid/gzer_02.png)*Imatge 3 - Identificació d'un grup ZER*
...
![](../../_media/esfera/mgac/gid/gzer_07.png)*Imatge 4 - Cerca d'alumnes*
...
![](../../_media/esfera/mgac/gid/gzer_08.png)*Imatge 5 - Llista d'alumnes del grup*
...
Si cal treure algun alumne del grup, cal seleccionar-lo de la llista d'alumnes i a continuació clicar al botó ![](../../_media/esfera/mgac/esborra.png).
...
Per afegir personal al grup cal clicar el botó ![](../../_media/esfera/mgac/afegeix.png).
...
![](../../_media/esfera/mgac/gid/gzer_03.png)*Imatge 6 - Cerca de personal de la ZER*
  
  
![](../../_media/esfera/mgac/gid/gzer_09.png)*Imatge 7 - Cerca de personal d'una escola*
  
  
Cal marcar les persones que es desitgi incorporar al grup i acabar clicant al botó ![](../../_media/esfera/mgac/desa.png).
  
Les persones passaran a mostrar-se a la llista de personal del grup.
  
  
Si cal treure alguna persona del grup cal seleccionar-lo de la llista i a continuació clicar al botó ![](../../_media/esfera/mgac/esborra.png).
...
![](../../_media/esfera/mgac/gid/gzer_04.png)*Imatge 8 - Altres dades del grup*
