...
* [Quines operacions s'hi poden fer](gid-gcla.md#quines-operacions-shi-poden-fer)
  ...
  + [Afegir](gid-gcla.md#afegir)

    - [Identificar el grup](gid-gcla.md#identificar-el-grup)
    - [Posar/treure alumnes al grup](gid-gcla.md#posartreure-alumnes-al-grup)
    - [Posar/treure continguts al grup](gid-gcla.md#posartreure-continguts-al-grup)
    - [Relacionar els professors amb els continguts](gid-gcla.md#relacionar-els-professors-amb-els-continguts)
  + [Esborrar](gid-gcla.md#esborrar)
  + [Copiar](gid-gcla.md#copiar)
  + [Consultar/Modificar](gid-gcla.md#consultarmodificar)
...
* [Afegir](gid-gcla.md#afegir) - Per crear nous grups classe.
* [Esborrar](gid-gcla.md#esborrar) - El programa permet esborrar un grup classe sempre que aquest no tingui alumnes, continguts, professors i tutor o tutora.
* [Copiar](gid-gcla.md#copiar) - Permet copiar la relació de grups identificats d'un curs al següent. En aquest procés de còpia no s'inclouen la llista dels alumnes, professors i continguts; només es copien les dades d'identificació dels grups classe.
* [Consultar/Modificar](gid-gcla.md#consultarmodificar) - Per veure la composició del grup, és a dir, la relació d'alumnes, continguts i professors que imparteixen cada contingut al grup i per modificar-lo, si és el cas.
...
* [Identificar el grup](gid-gcla.md#identificar-el-grup)
* [Afegir/treure alumnes al grup](gid-gcla.md#afegirtreure-alumnes-al-grup)
* [Afegir/treure continguts al grup](gid-gcla.md#afegirtreure-continguts-al-grup)
* [Relacionar els professors amb els continguts](gid-gcla.md#relacionar-els-professors-amb-els-continguts)
