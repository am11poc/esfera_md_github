...
* Té una capçalera amb els camps: **Curs escolar**, **Codi del grup**, **Nom del grup**, **Ensenyament**, **Nivell**, **Resta dades** [1)](sessioavalfinal.md#1), **Secretaria**, **Equip docent**, **Sessió**, **Signatura**, **Signada** i **Accions**.
...
* Prémer la icona ![](../../_media/esfera/mgac/i_canviaestat.png) que correspon al grup. [2)](sessioavalfinal.md#2)
...
* Prémer la icona ![](../../_media/esfera/mgac/i_canviaestat.png) que correspon al grup. [3)](sessioavalfinal.md#3)
...
* Si no s'han superat totes les validacions [4)](sessioavalfinal.md#4) es mostra a la pantalla un missatge amb els problemes/errors que s'han trobat. [5)](sessioavalfinal.md#5)
...
| Equip directiu i secretaria. [6)](sessioavalfinal.md#6)Els professors. [7)](sessioavalfinal.md#7)El tutor/a [8)](sessioavalfinal.md#8) | Accedir en mode consulta a l'entrada de qualificacions per grup i matèria, i per grup i alumne. |
...
| Equip directiu i secretaria amb autorització. [9)](sessioavalfinal.md#9)Els professors. [10)](sessioavalfinal.md#10)El tutor/a [11)](sessioavalfinal.md#11) | Accedir a l'entrada de qualificacions per grup i matèria i per grup i alumne. |
| Equip directiu i secretaria amb autorització i el tutor/a [12)](sessioavalfinal.md#12) | Entrar la data de la sessió d'avaluació. |
| Sessió | Els professors | Accedir en mode de consulta a l'entrada de qualificacions per grup i matèria, i per grup i alumne. |
| Equip directiu i secretaria amb autorització i el tutor/a [13)](sessioavalfinal.md#13) | Revisar les qualificacions i, si correspon, entrar les qualificacions globals i les conseqüències de l'avaluació. |
| Entrar la data de la sessió d'avaluació, assistents i acords. |
| En signatura | Equip directiu i secretaria amb autorització i el tutor/a [14)](sessioavalfinal.md#14) | Entrar la data de la sessió d'avaluació, assistents i acords. |
...
Al desplegable **Avaluació final de curs**, cal especificar-hi un **Sí** i prémer el botó ![](../../_media/esfera/mgac/genera.png). [15)](sessioavalfinal.md#15) Es genera un document en format PDF.
...
[1)](sessioavalfinal.md#1)
Règim i torn.

[2)](sessioavalfinal.md#2)
Per facilitar la cerca del grup podeu utilitzar els filtres que hi ha a la capçalera.

[3)](sessioavalfinal.md#3)
Consulteu la Imatge 3.

[4)](sessioavalfinal.md#4)
Per exemple, hi ha alumnes que no estan a cap grup classe.

[5)](sessioavalfinal.md#5)
En aquest cas, la relació d'alumnes que no estan a cap grup classe.

[6)](sessioavalfinal.md#6)
De tots els alumnes.

[7)](sessioavalfinal.md#7)
, [10)](sessioavalfinal.md#10)
Només dels grups i matèries que tenen assignats.

[8)](sessioavalfinal.md#8)
dels alumnes del grup de tutoria.

[9)](sessioavalfinal.md#9)
De tots els alumnes

[11)](sessioavalfinal.md#11)
Dels alumnes del grup de tutoria.

[12)](sessioavalfinal.md#12)
, [13)](sessioavalfinal.md#13)
, [14)](sessioavalfinal.md#14)
Del grup del qual és tutor.

[15)](sessioavalfinal.md#15)
