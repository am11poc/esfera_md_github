...
* [Què són](omavpargrua.md#què-són)
...
* ![](../../_media/esfera/mgac/i_lupa.png) [Permet afegir, als comentaris de la matèria,](omavpargrua.md#permet-afegir-als-comentaris-de-la-matèria) una frase del banc de frases assignat a l'element.
...
* Per entrar una frase del banc cal:
  ...
  4. Prémer el botó ![](../../_media/esfera/mgac/b_desa.png) que hi ha a la finestra **Afegir frases**.[5)](omavpargrua.md#5)
...
[3)](omavpargrua.md#3)
Es poden posar comentaris a cada matèria prement la icona ![](../../_media/esfera/mgac/i_accedeix.png).
