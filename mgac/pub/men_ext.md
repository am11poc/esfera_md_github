...
![](../../_media/esfera/mgac/pub/ext_1.png)*Imatge 1 - Pantalla per seleccionar Extraccions*
...
* [Afegir una extracció nova](men_ext.md#afegir-una-extracció-nova)
* [Esborrar una extracció existent](men_ext.md#esborrar-una-extracció-existent)
* [Fer una còpia d'una extracció existent](men_ext.md#fer-una-còpia-duna-extracció-existent)
* [Modificar una extracció existent](men_ext.md#modificar-una-extracció-existent)
* [Executar una extracció existent](men_ext.md#executar-una-extracció-existent)
...
Per afegir una nova extracció, cal prémer el botó ![](../../_media/esfera/mgac/afegeix.png).  
  
![](../../_media/esfera/mgac/pub/imatge_3.png)*Imatge 3 - Pantalla per afegir una extracció* 
...
![](../../_media/esfera/mgac/pub/ext_dg.png)*Imatge 4 - Pantalla per especificar les dades generals de l'extracció* 
...
![](../../_media/esfera/mgac/pub/ext_format.png)*Imatge 5 - Pantalla per especificar les característiques de format de l'extracció* 
...
![](../../_media/esfera/mgac/pub/ext_filtres.png)*Imatge 6 - Pantalla per especificar els filtres de l'extracció* 
...
![](../../_media/esfera/mgac/pub/ext_cs.png)*Imatge 7 - Espai per inserir els camps de l'extracció*
...
Els botons ![](../../_media/esfera/mgac/pl_afegirtreure.png) serveixen per afegir o treure camps de l'extracció; i els botons ![](../../_media/esfera/mgac/pl_ordenar.png) per ordenar-ne els camps.  
  
Quan s'han emplenat les dades generals, les característiques del format i els filtres, i s'han seleccionat els camps, cal prémer el botó ![](../../_media/esfera/mgac/b_desa.png).  
...
Per esborrar una o més extraccions, cal seleccionar les caselles de selecció corresponents i clicar al botó ![ ](../../_media/esfera/mgac/b_esborra.png " "), tal com es mostra a la imatge següent:  
![](../../_media/esfera/mgac/pub/imatge_8.png)*Imatge 8 - Esborrar una extracció*
...
Per fer una còpia d'una extracció cal clicar a la casella de verificació i prémer el botó ![](../../_media/esfera/mgac/b_copiar.png).

![](../../_media/esfera/mgac/pub/imatge_9.png)*Imatge 9 - Duplicar una extracció*
...
A continuació es mostren totes les dades de l'extracció agrupades en tres blocs tal com s'explica a [Afegir una extracció nova](men_ext.md#afegir-una-extracció-nova).  
...
![](../../_media/esfera/mgac/pub/imatge_11.png)*Imatge 11 - Pantalla per executar una extracció*
  
Cal prémer el botó ![](../../_media/esfera/mgac/b_executa.png).  
...
Per executar l'extracció, cal prémer el botó ![](../../_media/esfera/mgac/btn_executa.png). Aquest procés es fa en diferit, la qual cosa vol dir que es pot continuar treballant amb l'aplicació mentre s'elabora el document.  
