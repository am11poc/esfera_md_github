...
* [Què són](grups_classe.md#què-són)
* [Com s’hi accedeix](grups_classe.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](grups_classe.md#quines-operacions-shi-poden-fer)

  + [Afegir](grups_classe.md#afegir)

    - [Identificar el grup](grups_classe.md#identificar-el-grup)
    - [Posar/treure alumnes al grup](grups_classe.md#posartreure-alumnes-al-grup)
    - [Posar/treure continguts al grup](grups_classe.md#posartreure-continguts-al-grup)
    - [Relacionar els professors amb els continguts](grups_classe.md#relacionar-els-professors-amb-els-continguts)
  + [Esborrar](grups_classe.md#esborrar)
  + [Copiar](grups_classe.md#copiar)
  + [Consultar/Modificar](grups_classe.md#consultarmodificar)
...
![](../../../_media/esfera/mgac/gid/grup_classe_llista.png)*Imatge 1 - Llista de grups classe d'un centre*
...
![](../../../_media/esfera/mgac/gid/grup_classe_cerca.png)*Imatge 2 - Accés a Grups classe*
...
* [Afegir](grups_classe.md#afegir) - Per crear nous grups classe.
* [Esborrar](grups_classe.md#esborrar) - El programa permet esborrar un grup classe sempre que aquest no tingui alumnes, continguts, professors i tutor o tutora.
* [Copiar](grups_classe.md#copiar) - Permet copiar la relació de grups identificats d'un curs al següent. En aquest procés de còpia no s'inclouen la llista dels alumnes, professors i continguts; només es copien les dades d'identificació dels grups classe.
* [Consultar/Modificar](grups_classe.md#consultarmodificar) - Per veure la composició del grup, és a dir, la relació d'alumnes, continguts i professors que imparteixen cada contingut al grup i per modificar-lo, si és el cas.
...
* [Identificar el grup](grups_classe.md#identificar-el-grup)
* [Afegir/treure alumnes al grup](grups_classe.md#afegirtreure-alumnes-al-grup)
* [Afegir/treure continguts al grup](grups_classe.md#afegirtreure-continguts-al-grup)
* [Relacionar els professors amb els continguts](grups_classe.md#relacionar-els-professors-amb-els-continguts)
...
![](../../../_media/esfera/mgac/gid/grup_classe_identifica.png)*Imatge 3 - Dades d'identificació d'un grup classe*
...
![](../../../_media/esfera/mgac/gid/grup_classe_gestiona.png)*Imatge 4 - Dades d'identificació d'un grup classe*
...
Per afegir alumnes al grup cal clicar el botó ![](../../../_media/esfera/mgac/afegeix.png).
...
![](../../../_media/esfera/mgac/gid/grup_classe_alumnes.png)*Imatge 5 - Llista d'alumnes per incloure al grup classe*
  
  
Cal marcar els alumnes que es desitgi incorporar al grup i acabar clicant al botó ![](../../../_media/esfera/mgac/desa.png).
  
Els alumnes passaran a mostrar-se a la llista d'alumnes del grup.
  
![](../../../_media/esfera/mgac/gid/grup_classe_alumnes_2.png)*Imatge 6 - Llista d'alumnes del grup classe*
...
Si cal treure algun alumne del grup, s'ha de seleccionar de la llista d'alumnes del grup i a continuació clicar al botó ![](../../../_media/esfera/mgac/esborra.png).
...
![](../../../_media/esfera/mgac/gid/grup_classe_actualitza_continguts.png)*Imatge 7 - Actualitza continguts*
  
  
També és possible afegir altres continguts al grup. Per fer-ho s'ha de prémer el botó ![](../../../_media/esfera/mgac/afegeix.png), marcar els continguts desitjats i clicar al botó ![](../../../_media/esfera/mgac/desa.png) per incorporar-los al grup.
  
![](../../../_media/esfera/mgac/gid/grup_classe_continguts.png)*Imatge 8 -Selecció de continguts per afegir-los al grup classe*
  
  
Per eliminar els continguts del grup classe cal seleccionar els continguts del grup i clicar al botó ![](../../../_media/esfera/mgac/esborra.png).
  
![](../../../_media/esfera/mgac/gid/grup_classe_continguts_2.png)*Imatge 9 - Continguts del grup classe*
...
![](../../../_media/esfera/mgac/gid/grup_classe_professors.png)*Imatge 9 - Continguts i professors del grup classe*
...
![](../../../_media/esfera/mgac/gid/grup_classe_professors_2.png)*Imatge 10 - Professors del grup classe i continguts que imparteixen*
...
![](../../../_media/esfera/mgac/gid/grup_classe_altres.png)*Imatge 9 - Continguts del grup classe*
...
Cal marcar el grup o grups i prémer el botó ![](../../../_media/esfera/mgac/esborra.png).
...
S'han de seleccionar els grups necessaris i prémer el botó ![](../../../_media/esfera/mgac/copia.png).
