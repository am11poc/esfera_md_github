...
* [Què són](agrup_organ.md#què-són)
...
* [Quines operacions s'hi poden fer](agrup_organ.md#quines-operacions-shi-poden-fer)
  ...
  + [Crear una agrupació organitzativa](agrup_organ.md#crear-una-agrupació-organitzativa)
  + [Esborrar una agrupació organitzativa](agrup_organ.md#esborrar-una-agrupació-organitzativa)
  + [Modificar una agrupació organitzativa](agrup_organ.md#modificar-una-agrupació-organitzativa)
...
![](../../../_media/esfera/mgac/gid/aorg_01.png)*Imatge 1 - Llista d'agrupacions organitzatives del centre*
...
![](../../../_media/esfera/mgac/gid/aorg_02.png)*Imatge 2 - Accés a les agrupacions organitzatives*
...
* [Crear una agrupació organitzativa](agrup_organ.md#crear-una-agrupació-organitzativa) - Per crear noves agrupacions.
* [Modificar una agrupació organitzativa](agrup_organ.md#modificar-una-agrupació-organitzativa) - Per veure la composició de l'agrupació, és a dir, la relació d'alumnes, continguts i professors que imparteixen cada contingut a l'agrupació i per modificar-lo, si és el cas.
* [Esborrar una agrupació organitzativa](agrup_organ.md#esborrar-una-agrupació-organitzativa) - El programa permet esborrar una agrupació sempre que no tingui alumnes, continguts, professors i professor/a responsable.
...
* [Identificar l'agrupació](agrup_organ.md#identificar-lagrupació)
* [Afegir/treure continguts a l'agrupació](agrup_organ.md#afegirtreure-continguts-a-lagrupació)
* [Afegir/treure alumnes a l'agrupació](agrup_organ.md#afegirtreure-alumnes-a-lagrupació)
* [Revisar i modificar els professors de l'agrupació](agrup_organ.md#revisar-i-modificar-els-professors-de-lagrupació)
...
![](../../../_media/esfera/mgac/gid/aorg_03.png)*Imatge 3 - Identificació d'una agrupació organitzativa*
...
Per afegir continguts a l'agrupació cal clicar el botó ![](../../../_media/esfera/mgac/afegeix.png).
  
A la pantalla es mostren uns desplegables que permeten cercar continguts per ensenyament (obligatori) i nivell (opcional), marcar els continguts desitjats i clicar al botó ![](../../../_media/esfera/mgac/desa.png) per incorporar-los a l'agrupació.
  
  
![](../../../_media/esfera/mgac/gid/aorg_04.png)*Imatge 4 - Cerca de continguts d'educació infantil*
  
  
A continuació s'hi poden afegir continguts d'altres nivells i/o d'altres ensenyaments:
  
  
![](../../../_media/esfera/mgac/gid/aorg_05.png)*Imatge 5 - Cerca de continguts d'educació primària*
  
  
Un cop desat, a la pestanya "Continguts", es mostraran tots els continguts seleccionats de l'ensenyament i nivell.
  
  
![](../../../_media/esfera/mgac/gid/aorg_06.png)*Imatge 6 - Continguts de l'agrupació organitzativa*
  
  
Per eliminar els continguts de l'agrupació cal seleccionar-los i clicar al botó ![](../../../_media/esfera/mgac/esborra.png).
...
Per afegir alumnes a l'agrupació cal clicar el botó ![](../../../_media/esfera/mgac/afegeix.png).
...
![](../../../_media/esfera/mgac/gid/aorg_07.png)*Imatge 7 - Llista d'alumnes que tenen algun contingut de l'agrupació*
  
  
Cal marcar els alumnes que es desitgi incorporar a l'agrupació i acabar clicant al botó ![](../../../_media/esfera/mgac/desa.png).
  
Els alumnes passaran a mostrar-se a la llista d'alumnes de l'agrupació.
  
![](../../../_media/esfera/mgac/gid/aorg_08.png)*Imatge 8 - Llista d'alumnes de l'agrupació*
...
Si cal treure algun alumne de l'agrupació, cal seleccionar-lo de la llista d'alumnes i a continuació clicar al botó ![](../../../_media/esfera/mgac/esborra.png).
...
![](../../../_media/esfera/mgac/gid/aorg_09.png)*Imatge 9 - Professors de l'agrupació*
...
![](../../../_media/esfera/mgac/gid/aorg_10.png)*Imatge 10 - Altres dades de l'agrupació*
...
Cal marcar l'agrupació o agrupacions i prémer el botó ![](../../../_media/esfera/mgac/esborra.png).
