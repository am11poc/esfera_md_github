...
* [Quines operacions s'hi poden fer](sessio_crear.md#quines-operacions-shi-poden-fer)
  ...
  + [Crear o canviar la sessió d'avaluació d'un grup](sessio_crear.md#crear-o-canviar-la-sessio-davaluacio-dun-grup)
  + [Entrar les dades d'una sessió d'avaluació: data, assistents i acords](sessio_crear.md#entrar-les-dades-duna-sessio-davaluacio-data-assistents-i-acords)
...
* Seleccionar l'opció de menú [Sessió d'avaluació](sessio_crear.md#sessio-davaluacio) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
...
* Seleccionar l'opció del menú [Sessió d'avaluació](sessio_crear.md#sessio-davaluacio) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
...
* [Butlletins i acusament de recepció](sessio_crear.md#butlletins-i-acusament-de-recepcio)
...
Al desplegable **Avaluació parcial de curs** cal especificar-hi **Sí** i prémer el botó ![](../../../_media/esfera/mgac/genera.png).[18)](sessio_crear.md#18)
