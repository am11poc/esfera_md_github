...
* [Esborrar](curr_centre.md#esborrar) - Permet esborrar els currículums del centre que ja no interessi mantenir[1)](curr_centre.md#1). El programa controla que, per a cada ensenyament i nivell, hi hagi almenys un currículum del centre, i no deixa esborrar el currículum si aquest és el darrer que hi ha.

* [Cas particular de les ZER](curr_centre.md#cas-particular-de-les-zer) - Totes les escoles d'una ZER comparteixen el Projecte educatiu. En aquest cas, la ZER defineix els currículums comuns per a tots els centres; posteriorment, cada centre pot fer-ne una petita adaptació.
...
**2)** Marcar la casella de selecció corresponent al currículum que es vol copiar [2)](curr_centre.md#2)
...
**3)** Introduir les dades[3)](curr_centre.md#3)
...
**2)** Marcar la casella corresponent al currículum que es vol esborrar. [4)](curr_centre.md#4)
...
La ZER pot crear els currículums del centre amb totes les funcions, tal com s'ha descrit [anteriorment](curr_centre.md#anteriorment).
...
* El comportament dels botons [Afegeix](curr_centre.md#afegeix) i [Esborra](curr_centre.md#esborra) és anàleg al que s'ha explicat abans.
...
* El funcionament del botó [Copiar](curr_centre.md#copiar) és el mateix que s'ha explicat per copiar currículums en altres centres.
