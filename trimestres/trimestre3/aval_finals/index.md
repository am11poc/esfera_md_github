...
| **Cicles formatius** |  | | Es poden fer[1)](index.md#1) tantes avaluacions finals com sigui necessari. A cada sessió, s'avaluen totes les unitats formatives i els mòduls professionals que l'alumne tingui a la matrícula i que no hagi superat ja en una sessió d'avaluació anterior. [2)](index.md#2) |
| **Cicles formatius d'arts plàstiques i disseny** |  | | Es poden fer fins a tres sessions avaluacions finals; si es fa una tercera sessió, aquesta és extraordinària. A cada sessió, s'avaluen totes les unitats formatives i els mòduls professionals que l'alumne tingui a la matrícula i que no hagi superat ja en una sessió d'avaluació anterior. [3)](index.md#3) |
...
* Creació de la sessió d'avaluació. [4)](index.md#4)
* Revisió de les dades. [5)](index.md#5)
* Fer el canvi d'estat, de **Secretaria** a **Equip docent**. [6)](index.md#6)
...
* Entrar les qualificacions:
  ...
  + Els professors han d'entrar les qualificacions als alumnes del grup. [7)](index.md#7)[8)](index.md#8)
  + El tutor o tutora del grup també pot veure i entrar les qualificacions de totes les matèries del grup. [9)](index.md#9)
  + L'equip directiu o el personal de secretaria també poden entrar les qualificacions de tots els grups i matèries. [10)](index.md#10)
* Fer el canvi d'estat d'**Equip docent** a **Sessió**. [11)](index.md#11)
...
* Impressió dels documents per a la sessió d'avaluació. [12)](index.md#12)
* Revisió de les qualificacions de totes les matèries dels alumnes. [13)](index.md#13)
* Completar l'avaluació dels alumnes i entrar les dades de la sessió d'avaluació; entrar les conseqüències de l'avaluació, la data de la sessió, els assistents i els acords. [14)](index.md#14)
* Fer el canvi d'estat **Sessió** a **En signatura**. [15)](index.md#15)
...
* Impressió de les actes i els informes d'avaluació. [16)](index.md#16)
* Comprovar les dades. [17)](index.md#17)
* Fer el canvi d'estat de **En signatura** a **Signada**. [18)](index.md#18)
...
* Arxivar l'acta d'avaluació del grup. [19)](index.md#19)
...
![](../../../_media/esfera/mgac/aval/ava_estats_final.png)*Imatge 2 - Avaluacions finals - Estats de les sessions d'avaluació*
...
![](../../../_media/esfera/mgac/aval/aval-af_4.png)*Imatge 1 - Accés a Sessió d'avaluació*

![](../../../_media/esfera/mgac/aval/aval-af_3.png)*Imatge 2 - Pantalla d'una sessió d'avaluació*
...
| Canviar l'estat de la sessió d'avaluació [20)](index.md#20) |  |  |  |  |  |
| Modificacions, si escau, del currículum dels alumnes [21)](index.md#21) |  |  |  |  |  |
| Entrar/Consultar qualificacions per grup i matèria [22)](index.md#22) [23)](index.md#23) |  |  |  |  |  |
| Entrar/Consultar qualificacions per grup i alumne/a [24)](index.md#24) |  |  |  |  |  |
| Preparar la sessió d'avaluació |  |  |  |  |  |
| Informar camps resum de l'avaluació |  |  |  |  |  |
| Entrada de les dades de la sessió d'avaluació [25)](index.md#25) |  |  |  |  |  |
| Impressió de les actes d'avaluació [26)](index.md#26) |  |  |  |  |  |
| Impressió dels informes d'avaluació [27)](index.md#27) |  |  |  |  |  |
| Arxiu de les actes |  |  |  |  |  |
