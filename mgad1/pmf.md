...
- Si s’avalua amb el model basada la normativa, sí.
- Amb el “Model d’avaluació parcial pròpia del centre”, cal enregistra-ho durant l’avaluació.
...
Les vigències dels elements curriculars serveixen per delimitar el temps que seran operatius a les avaluacions parcials dels alumnes.
Per exemple, si un element curricular té com a fi de vigència el 31 de desembre, a la segona avaluació parcial ja no es mostrarà a la pantalla de l'avaluació ni als informes. Si un altre element té inici de vigència, per exemple, el 15 d'abril, aquest només veurà a partir del 15 d'abril.
...
És un registre informàtic, únic per alumne/a i ensenyament, de totes les dades necessàries per generar tota la documentació oficial següent:
- Historial acadèmic de l’alumne/a
- Expedient de l’alumne/a
- Si escau: informe final d’etapa i informe personal per trasllat
...
És un procés que es fa des del mòdul [Gestió administrativa](../mgac/gadmin/peti_docum.md).
...
| **5è** |  | 1r LOE | 2n LOE | **3r LOEM** | **4t LOEM** | **5è LOEM** |
| **6è** | 1r LOE | 2n LOE | 3r LOE | 4t LOE | **5è LOEM** | **6è LOEM** |
...
Al **Portal de centres** podeu consultar la informació del [RALC](http://educacio.gencat.cat/portal/page/portal/EducacioIntranet/Inici/PortalCentres/pcGestioAdministrativa/Detall).
...
Hi ha dues maneres:
- prement a la vegada les tecles “Crtl” i “+” (o “-” per fer-la més petita);
- prement “Crtl” i movent la roda del ratolí.
