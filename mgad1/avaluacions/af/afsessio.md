...
* Té una capçalera amb els camps: **Curs escolar**, **Codi del grup**, **Nom del grup**, **Ensenyament**, **Nivell**, **Resta dades** [1)](afsessio.md#1), **Secretaria**, **Equip docent**, **Sessió**, **Signatura**, **Signada** i **Accions**.
...
* Prémer la icona ![](../../../_media/esfera/mgac/i_canviaestat.png) que correspon al grup. [2)](afsessio.md#2)
...
* Prémer la icona ![](../../../_media/esfera/mgac/i_canviaestat.png) que correspon al grup. [3)](afsessio.md#3)
...
* Si no s'han superat totes les validacions [4)](afsessio.md#4) es mostra a la pantalla un missatge amb els problemes/errors que s'han trobat. [5)](afsessio.md#5)
...
| Equip directiu i secretaria. [6)](afsessio.md#6)Els professors. [7)](afsessio.md#7)El tutor/a [8)](afsessio.md#8) | Accedir en mode consulta a l'entrada de qualificacions per grup i matèria, i per grup i alumne. |
...
| Equip directiu i secretaria amb autorització. [9)](afsessio.md#9)Els professors. [10)](afsessio.md#10)El tutor/a [11)](afsessio.md#11) | Accedir a l'entrada de qualificacions per grup i matèria i per grup i alumne. |
| Equip directiu i secretaria amb autorització i el tutor/a [12)](afsessio.md#12) | Entrar la data de la sessió d'avaluació. |
| Sessió | Els professors | Accedir en mode de consulta a l'entrada de qualificacions per grup i matèria, i per grup i alumne. |
| Equip directiu i secretaria amb autorització i el tutor/a [13)](afsessio.md#13) | Revisar les qualificacions i, si correspon, entrar les qualificacions globals i les conseqüències de l'avaluació. |
| Entrar la data de la sessió d'avaluació, assistents i acords. |
| En signatura | Equip directiu i secretaria amb autorització i el tutor/a [14)](afsessio.md#14) | Entrar la data de la sessió d'avaluació, assistents i acords. |
...
Al desplegable **Avaluació final de curs**, cal especificar-hi un **Sí** i prémer el botó ![](../../../_media/esfera/mgac/genera.png). [15)](afsessio.md#15) Es genera un document en format PDF.
