...
* Fer les avaluacions parcials amb el **Model d'avaluació parcial pròpia del centre**; cal definir-ho tot [1)](index.md#1).

Per a cada ensenyament[2)](index.md#2) el centre ha d'especificar el model d'avaluació que vol aplicar i, en el cas d'optar pel **Model d'avaluació parcial pròpia del centre**, concretar els literals que farà servir per a l'avaluació, i els **Elements propis del centre** que vol avaluar.
...
* Fer les avaluacions parcials en **Model d'avaluació parcial pròpia del centre**. Avaluar els **Elements propis del centre** que el centre determini: avaluar per projectes, per àmbits genèrics, aspectes concrets… [3)](index.md#3). El centre també escull els literals que vol fer servir a l'avaluació: si vol avaluar amb xifres, de manera qualitativa, amb frases o de manera combinada. En el model lliure sols es podrà fer l'entrada de qualificacions per **Grup i alumne/a**.
...
L'avaluació es desenvolupa en **fases** que en el programa es tradueixen en **estats**.![](../../../_media/esfera/mgac/aval/fases_parcial.png)*Imatge 2 - Avaluacions parcials - Correspondència entre fases i estats de les avaluacions parcials*
...
* Crear la sessió d'avaluació, si escau (la 1a sessió es crea de forma automàtica després de triar el model d'avaluació parcial). [4)](index.md#4)
* Si s'ha optat pel **Model d'avaluació parcial pròpia del centre**, crear els **Elements propis del centre**. [5)](index.md#5)
* Creació del banc de frases, les frases i assignació d'aquestes als **Elements curriculars** o als **Elements propis del centre**. [6)](index.md#6)
* Revisar les dades:

  + Si les avaluacions parcials es fan del tipus **Basada en la normativa**. [7)](index.md#7)
  + Si les avaluacions parcials es fan amb el **Model d'avaluació parcial pròpia del centre**. [8)](index.md#8)
* Fer el canvi d'estat, de **Secretaria** a **Professors**. Aquest canvi d'estat no és immediat. Es fa efectiu l'endemà d'haver-lo sol·licitat. [9)](index.md#9)
...
* Imprimir els documents per a la sessió d'avaluació. [13)](index.md#13)
* Revisar les qualificacions de totes les matèries dels alumnes. [14)](index.md#14)
* Entrar les dades de la sessió d'avaluació; la data de la sessió, els assistents, acords. [15)](index.md#15)
* Fer el canvi d'estat **Junta** a **Tancada**. [16)](index.md#16)
...
| --- | --- | --- | --- | --- |
| Canviar l'estat de la sessió d'avaluació [17)](index.md#17) |  |  |  |  |
| Revisar els continguts que cal tenir en compte a l'avaluació dels alumnes [18)](index.md#18) |  |  |  |  |
| Entrada de qualificacions per grup i matèria [19)](index.md#19) |  |  |  |  |
| Consulta de qualificacions per grup i matèria [20)](index.md#20) |  |  |  |  |
| Entrada de qualificacions per grup i alumne/a [21)](index.md#21) |  |  |  | [22)](index.md#22) |
| Entrada de les dades de la sessió d'avaluació [23)](index.md#23) |  |  |  |  |
| Impressió de les actes d'avaluació [24)](index.md#24) |  |  |  |  |
| Impressió dels informes d'avaluació [25)](index.md#25) |  |  |  |  |
| Arxivar les actes |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| Canviar l'estat de la sessió d'avaluació [26)](index.md#26) |  | [27)](index.md#27) |  |  |  |
| Revisar els continguts que cal tenir en compte a l'avaluació dels alumnes [28)](index.md#28) |  |  |  |  |  |
| Entrada de qualificacions per grup i matèria [29)](index.md#29) |  |  |  |  |  |
| Consulta de qualificacions per grup i matèria [30)](index.md#30) |  |  |  |  |  |
| Entrada de qualificacions per grup i alumne/a [31)](index.md#31) |  |  |  |  |  |
| Entrada de les dades de la sessió d'avaluació [32)](index.md#32) |  |  |  |  |  |
| Impressió de les actes d'avaluació [33)](index.md#33) |  |  |  |  |  |
| Impressió dels informes d'avaluació [34)](index.md#34) |  |  |  |  |  |
| Arxivar les actes [35)](index.md#35) |  |  |  |  |  |
