...
* [Què són](apelepec.md#què-són)
* [Com s'hi accedeix](apelepec.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](apelepec.md#quines-operacions-shi-poden-fer)
...
![](../../../_media/esfera/mgac/aval/avpar_pecestr.png)*Imatge 1 - Estructura dels elements propis del centre*

* El centre pot escollir avaluar només elements del nivell I, o del nivell I i II, o dels tres nivells.
* A la taula dels elements propis del centre, a més dels de creació pròpia, es pot disposar d'una còpia dels normatius. [1)](apelepec.md#1)
...
![](../../../_media/esfera/mgac/aval/avpar_pec0.png)*Imatge 2 - Accés a l'opció Elements propis del centre*

![](../../../_media/esfera/mgac/aval/avpar_pec01.png)*Imatge 3 - Llista d'ensenyaments i nivells del centre*
...
* Per gestionar els elements propis del centre s'ha de prémer la icona ![](../../../_media/esfera/mgac/i_accedeix.png) que correspongui a l'ensenyament i nivell que es vulgui editar.

![](../../../_media/esfera/mgac/aval/avpar_pec02.png)*Imatge 4 - Taula buida dels elements propis del centre d'un ensenyament i nivell*
...
Per crear un nou element propi del centre cal prémer el botó ![](../../../_media/esfera/mgac/b_afegeix.png) que hi ha a sobre de la taula.
![](../../../_media/esfera/mgac/aval/creaep2.png)*Imatge 4 - Accés a la creació d'un element propi del centre*
![](../../../_media/esfera/mgac/aval/creaep1.png)*Imatge 5 - Pantalla d'entrada de dades de l'element* 
...
Es pot fer la còpia d'[algun dels elements curriculars](apelepec.md#algun-dels-elements-curriculars) sense mantenir la relació d'estructura[2)](apelepec.md#2), o bé fer la [de diversos elements mantenint l'estructura de relació.](apelepec.md#de-diversos-elements-mantenint-lestructura-de-relació) [3)](apelepec.md#3)

#### Còpia dels elements de forma independent

![](../../../_media/esfera/mgac/aval/avpar_pec_rep1.png)*Imatge 6 - Pantalla per copiar els elements curriculars normatius sense mantenir l'estructura de relació*

* Per cada un dels nivells s'ha de seleccionar l'element que es vol copiar.
* Per finalitzar cal prémer el botó ![](../../../_media/esfera/mgac/b_desa.png)
...
![](../../../_media/esfera/mgac/aval/avpar_pec_rep2.png)*Imatge 7 - Pantalla per copiar els elements curriculars mantenint l'estructura de relació*
...
![](../../../_media/esfera/mgac/aval/avpar_pec_ne.png)*Imatge 8 - Llista d'elements propis del centre sense cap relació organitzativa*
...
![](../../../_media/esfera/mgac/aval/avpar_pec_es.png)*Imatge 9 - Llista d'elements propis del centre amb una relació organitzativa*
...
![](../../../_media/esfera/mgac/aval/avpar_pec_pare.png)*Imatge 10 - Edició de l'element pare*
