...
* [Quines operacions s'hi poden fer](apsessio.md#quines-operacions-shi-poden-fer)
  ...
  + [Crear o canviar la sessió d'avaluació d'un grup](apsessio.md#crear-o-canviar-la-sessio-davaluacio-dun-grup)
  + [Entrar les dades d'una sessió d'avaluació: data, assistents i acords](apsessio.md#entrar-les-dades-duna-sessio-davaluacio-data-assistents-i-acords)
...
* Seleccionar l'opció de menú [Sessió d'avaluació](apsessio.md#sessio-davaluacio) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
...
* Seleccionar l'opció del menú [Sessió d'avaluació](apsessio.md#sessio-davaluacio) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
...
* [Butlletins i acusament de recepció](apsessio.md#butlletins-i-acusament-de-recepcio)
