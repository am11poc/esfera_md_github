...
* [Què és](apsessio.md#què-és)
* [Com s'hi accedeix](apsessio.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](apsessio.md#quines-operacions-shi-poden-fer)

  + [Crear o canviar la sessió d'avaluació d'un grup](apsessio.md#crear-o-canviar-la-sessió-davaluació-dun-grup)
  + [Entrar les dades d'una sessió d'avaluació: data, assistents i acords](apsessio.md#entrar-les-dades-duna-sessió-davaluació-data-assistents-i-acords)
  + [Imprimir els documents](apsessio.md#imprimir-els-documents)
...
![](../../../_media/esfera/mgac/aval/ap_sessio1.png)*Imatge 1 - Accés a l'opció de menú Sessió d'avaluació del mòdul Avaluacions parcials*

![](../../../_media/esfera/mgac/aval/ap_sessio2.png)*Imatge 2 - Llista de grups classe i sessions d'avaluació parcials*

La pantalla mostra la taula de grups i les sessions d'avaluació:

* Té una capçalera amb els camps: **Curs escolar**, **Codi del grup**, **Nom del grup**, **Ensenyament**, **Nivell**, **Resta dades**[1)](apsessio.md#1), **Secretaria**, **Professors**, **Junta**, **Tancada** i **Accions**.
...
* A la columna d'accions hi ha dues icones![](../../../_media/esfera/mgac/i_accedeix.png):![](../../../_media/esfera/mgac/i_canviaestat.png)
  ...
  + ![](../../../_media/esfera/mgac/i_accedeix.png) Permet accedir al detall de la sessió d'avaluació per poder-hi entrar la data de la sessió, els acords, els assistents i altres assistents.
...
* Seleccionar l'opció de menú [Sessió d'avaluació](apsessio.md#sessió-davaluació) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
...
* Prémer la icona ![](../../../_media/esfera/mgac/i_canviaestat.png) que correspon al grup.[2)](apsessio.md#2)

![](../../../_media/esfera/mgac/aval/ap_sessio4.png)*Imatge 4- Pantalla de les sessions d'avaluació d'un grup que no té cap sessió creada*

* Prémer el botó ![](../../../_media/esfera/mgac/b_afegeix.png)

![](../../../_media/esfera/mgac/aval/ap_sessio5.png)*Imatge 5- Pantalla de confirmació*

* Prémer el botó ![](../../../_media/esfera/mgac/b_confirma.png)

![](../../../_media/esfera/mgac/aval/ap_sessio6.png)*Imatge 6- Pantalla de la sessió d'avaluació en estat Secretaria*
...
* Seleccionar l'opció de menú [Sessió d'avaluació](apsessio.md#sessió-davaluació) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
* Prémer la icona ![](../../../_media/esfera/mgac/i_canviaestat.png) que correspon al grup.[3)](apsessio.md#3)
...
![](../../../_media/esfera/mgac/aval/ap_sessio7.png)*Imatge 8- Pantalla de confirmació*

* Prémer el botó ![](../../../_media/esfera/mgac/b_desa.png).

![](../../../_media/esfera/mgac/aval/ap_sessioc1.png)*Imatge 9- Informació de què s'ha iniciat el canvi d'estat de la sessió*
...
![](../../../_media/esfera/mgac/aval/ap_sessio9.png)*Imatge 10- Informació de què s'ha iniciat el canvi d'estat de la sessió*

* Si no s'han superat totes les validacions[4)](apsessio.md#4) es mostra a la pantalla un missatge amb els problemes/errors que s'han detectat.[5)](apsessio.md#5)

![](../../../_media/esfera/mgac/aval/af_sessio_crearav8.png)*Imatge 11- Problemes que han impedit fer el canvi d'estat*

* Després d'esmenar els errors podeu tornar a prémer el botó ![](../../../_media/esfera/mgac/b_canvia_estat.png).
...
| Equip directiu i secretaria.[6)](apsessio.md#6) Els professors.[7)](apsessio.md#7) El tutor/a [8)](apsessio.md#8) | Accedir en mode consulta a l'entrada de qualificacions per grup i matèria[9)](apsessio.md#9) i per grup i alumne. |
...
| Equip directiu i secretaria amb autorització.[10)](apsessio.md#10) Els professors.[11)](apsessio.md#11) El tutor/a [12)](apsessio.md#12) | Entrar qualificacions per grup i matèria[13)](apsessio.md#13), i per grup i alumne. |
| Equip directiu i secretaria amb autorització i el tutor/a[14)](apsessio.md#14) | Entrar la data de la sessió d'avaluació. |
| Junta | Els professors | Accedir en mode de consulta a l'entrada de qualificacions per grup i matèria[15)](apsessio.md#15), i per grup i alumne. |
| Equip directiu i secretaria amb autorització i el tutor/a[16)](apsessio.md#16) | Revisar les qualificacions i, si correspon, entrar les qualificacions globals. |
| Entrar la data de la sessió d'avaluació, els assistents i els acords. |
| Tancada | Equip directiu i secretaria amb autorització i el tutor/a[17)](apsessio.md#17) | Entrar la data de la sessió d'avaluació, els assistents i els acords. |
...
* Seleccionar l'opció del menú [Sessió d'avaluació](apsessio.md#sessió-davaluació) del submòdul **Avaluacions parcials** del mòdul **Avaluacions**.
...
![](../../../_media/esfera/mgac/aval/ap_sessio_e2.png)*Imatge 13- Pantalla d'entrada de dades d'una sessió d'avaluació*
...
* [Actes](apsessio.md#actes)
* [Butlletins i acusament de recepció](apsessio.md#butlletins-i-acusament-de-recepció)
...
![](../../../_media/esfera/mgac/aval/ap_se_im1.png)*Imatge 14 - Pantalla d'accés a actes i informes de qualificacions*

A la pantalla, cal marcar la casella corresponent al grup/grups del qual es vol obtenir l'acta i/o els informes i clicar al botó ![](../../../_media/esfera/mgac/documents.png) de la part superior.  
![](../../../_media/esfera/mgac/aval/ap_se_im2.png)*Imatge 15 - Selecció dels documents*
...
Al desplegable **Avaluació parcial de curs** cal especificar-hi **Sí** i prémer el botó ![](../../../_media/esfera/mgac/genera.png).[18)](apsessio.md#18)
![](../../../_media/esfera/mgac/aval/ap_se_im3.png)*Imatge 16 - Acta de primària*
...
![](../../../_media/esfera/mgac/aval/ap_se_im4.png)*Imatge 17 - Acta de primària*

![](../../../_media/esfera/mgac/aval/ap_se_im5.png)*Imatge 18 - Qualificacions de primària*

#### Butlletins i acusament de recepció

Es poden imprimir els informes de qualificacions i també els d'acusament de recepció.
Al desplegable **Informe de qualificacions** cal especificar **Sí**, i al desplegable **Acusament de recepció**, també **Sí**, després de seleccionar els alumnes i prémer el botó ![](../../../_media/esfera/mgac/genera.png). Després es genera un document ZIP amb els informes i els acusaments en format PDF.

![](../../../_media/esfera/mgac/aval/ap_se_im6.png)*Imatge 19 - Informes de qualificacions*

![](../../../_media/esfera/mgac/aval/ap_se_im7.png)*Imatge 20 - Acusament de recepció*
