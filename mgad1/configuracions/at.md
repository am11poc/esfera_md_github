...
* [Quines operacions s'hi poden fer](at.md#quines-operacions-shi-poden-fer)
  ...
  + [Mesures](at.md#mesures)
  + [Suports](at.md#suports)
...
![](../../_media/esfera/mgac/cnf/ad_01.png)*Imatge 1 - Accés a l'apartat Atenció a la diversitat*
...
* [Mesures i suports disponibles per a tots els centres](at.md#mesures-i-suports-disponibles-per-a-tots-els-centres), on el centre en pot afegir i treure d'entre les opcions del desplegable d'acord a les definides per les unitats administratives.
* [Mesures i suports assignats al centre](at.md#mesures-i-suports-assignats-al-centre), definits per les unitats administratives i que el centre no pot modificar.
...
![](../../_media/esfera/mgac/cnf/cnf_atdiv_1819.png)*Imatge 2 - Llista de les mesures i suports*
...
Per afegir una mesura i/o suport assignat per a tots els centres, cal prémer el botó ![](../../_media/esfera/mgac/b_afegeix.png) del primer bloc.
...
![](../../_media/esfera/mgac/cnf/ad_3.png)*Imatge 3 - Pantalla per afegir mesures i suports assignats a tots els centres*

Si es vol eliminar una mesura i/o suport, cal seleccionar-la i prémer el botó ![](../../_media/esfera/mgac/b_esborra.png). Només s'esborrarà si no s'ha aplicat a cap alumne.
