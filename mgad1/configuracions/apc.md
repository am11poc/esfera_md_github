...
![](../../_media/esfera/mgac/cnf/auto_01.png)*Imatge 1 - Autoritzacions del personal del centre*

![](../../_media/esfera/mgac/cnf/ap_2.png)*Imatge 2 - Llista del personal del centre*
...
Per canviar les característiques d'accés a una persona, s'ha de clicar a la icona ![](../../_media/esfera/mgac/i_accedeix.png) de la columna **Accions**.

![](../../_media/esfera/mgac/cnf/ap_3.png)*Imatge 3 - Selecció per canviar les característiques d'accés*

Tot seguit, apareix una finestra amb la llista de les funcionalitats de l'aplicació on s'hi pot donar accés.

![](../../_media/esfera/mgac/cnf/ap_4.png)*Imatge 4 - Llista d'autoritzacions d'un treballador del centre*

Després cal seleccionar la funcionalitat i escollir el nou permís al desplegable de la columna **Autorització nominal**.

Els valors possibles són:
![](../../_media/esfera/mgac/cnf/auto_05.png)*Imatge 5 - Valors possibles*
...
![](../../_media/esfera/mgac/cnf/ap_5.png)*Imatge 6 - Missatge d'avís per desar els canvis*
...
![](../../_media/esfera/mgac/cnf/auto_04.png)*Imatge 7 - Llista d'autoritzacions a una funcionalitat d'un treballador del centre*
