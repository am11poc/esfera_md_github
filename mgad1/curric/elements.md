...
![](../../_media/esfera/mgac/curr_elements_eso_llista.png)*Imatge 1 - Llista d'elements curriculars d'ESO. En aquesta taula, a més dels continguts normatius, hi ha també continguts del centre (en gris i en cursiva).*
...
![](../../_media/esfera/mgac/curr_elements_cur.png)*Imatge 2 - Opció del menú "Elements curriculars"*
  
La imatge anterior mostra una taula amb el codi i el nom dels diferents ensenyaments del centre, i per cadascun, a la columna d'accions, hi ha la icona ![](../../_media/esfera/mgac/i_accedeix.png) que permet accedir al detall.  
...
* [Consultar](elements.md#consultar) - Per veure la relació de tots els elements curriculars que corresponen a un ensenyament.
* [Editar (els continguts de centre)](elements.md#editar-els-continguts-de-centre) - A ESO, batxillerat i cicles formatius, a més dels elements curriculars normatius, hi poden haver continguts del centre que, al llarg dels anys, aquest ha creat per a l'ensenyament.

  + [Modificar](elements.md#modificar) - Permet corregir el nom i/o el pes de referència així com modificar les dates d'inici i de fi de la vigència (aquesta funció és especialment útil si hi ha continguts que han quedat obsolets. El fet de fer-los no vigents, evitarà afegir-los als currículums del centre, però no té cap efecte a les dades dels alumnes que els tenen al seu expedient).
...
![](../../_media/esfera/mgac/curr_elements_cur.png)*Imatge 3 - Selecció d'elements curriculars*  
**2)** Prémer la icona ![](../../_media/esfera/mgac/i_accedeix.png) que correspon a l'ensenyament.
  
![](../../_media/esfera/mgac/curr_elements_eso_llista.png)*Imatge 4 - Llista d'elements curriculars d'ESO*

* Es mostra una taula, amb tots els elements curriculars que corresponen a l'ensenyament, amb una casella de verificació (per marcar els que es vol esborrar), el codi, el nom, les hores de base, l'origen (si és normatiu o de centre) i les dades d'inici i fi de la vigència. A la columna d'accions hi ha la icona ![](../../_media/esfera/mgac/i_accedeix.png) per accedir-ne al detall.
* A la part superior de la taula hi ha tres botons ![](../../_media/esfera/mgac/b_afegeix.png)![](../../_media/esfera/mgac/b_esborra_p.png)![](../../_media/esfera/mgac/boto_mostrar_novigents_data.png), a les funcions de manteniment que es descriuen a continuació es detallen les funcions d'aquests botons i de la icona ![](../../_media/esfera/mgac/i_accedeix.png)
...
![](../../_media/esfera/mgac/curr_elements_eso4_llista.png)*Imatge 5 - Llista d'elements curriculars de 4t d'ESO*
...
**1)** Fer les accions corresponents a la funció [Consultar](elements.md#consultar).
  
**2)** Cercar el contingut que es vol modificar.
Per facilitar la cerca, al filtre de la capçalera del camp "Nom" es pot escriure el nom del contingut o una **c** [1)](elements.md#1) al camp "Origen" per a que sols mostri els de **c**entre.
  
![](../../_media/esfera/mgac/curri/cur_element_centre.png)*Imatge 6 - Llista d'elements curriculars de centre*
  
**3)** Prémer la icona ![](../../_media/esfera/mgac/i_accedeix.png) que correspongui a l'element que es vol editar
...
![](../../_media/esfera/mgac/curri-element-baixa.png)*Imatge 7 - Element curricular amb data de baixa* 
  
**5)** Prémer el botó ![](../../_media/esfera/mgac/b_desa.png).
  
![](../../_media/esfera/mgac/curri-element-vigents.png)*Imatge 8 - Visualització dels continguts vigents*
...
**2)** Prémer el botó ![](../../_media/esfera/mgac/b_afegeix.png) que hi ha sobre de la taula dels elements curriculars.
  
![](../../_media/esfera/mgac/form_element_curricular.png)*Imatge 9 - Pantalla de creació d'elements curriculars per l'ESO*  
![](../../_media/esfera/mgac/form_element_curricular_batx.png)*Imatge 10 - Pantalla de creació d'elements curriculars per el Batxillerat*

* El programa mostra la fitxa dels elements curriculars, amb els camps següents[2)](elements.md#2):
  ...
  + **Codi** - S'ha d'entrar un codi alfanumèric i únic[3)](elements.md#3). Per a l'ESO i el batxillerat, l'últim caràcter ha de ser un número en el cas que el contingut s'ofereixi a un nivell concret. En el cas dels cicles formatius el codi ha de ser un text.
  + **Nom/Matèria** - S'ha d'entrar el nom del contingut, que ha de ser únic[4)](elements.md#4).
...
![](../../_media/esfera/mgac/curri/curr-ele-esbor.png)*Imatge 11 - Llista de mòduls i unitats formatives d'un cicle formatiu i selecció d'un mòdul del centre per esborrar*
  
**4)** Prémer el botó ![](../../_media/esfera/mgac/b_esborra.png). Apareix una pantalla demanant la conformitat per esborrar el contingut.
  
![](../../_media/esfera/mgac/curri/curr-confirma-esbo.png)*Imatge 12 - Pantalla de confirmació*
  
**5)** Prémer el botó ![](../../_media/esfera/mgac/b_confirma.png).

* Es mostra el missatge assegurant que s'ha eliminat el contingut.

![](../../_media/esfera/mgac/curri/curr_esborra_exit.png)*Imatge 13 - Pantalla amb el missatge tal com l'element s'ha esborrat.*
...
En la [consulta](elements.md#consulta) dels elements curriculars d'un ensenyament, en qualsevol moment, es pot demanar al programa que mostri tots els continguts, tant els vigents com els no vigents.  
**Atenció, la vigència la mira en relació a la data de 01/09/YYYY on YYYY és l'any d'inici del curs escolar**
  
Si es prem el botó ![](../../_media/esfera/mgac/boto_mostrar_novigents_data.png), el programa mostra tots els continguts.  
![](../../_media/esfera/mgac/curr-ele-novigents.png)*Imatge 14 - Llista de tots els continguts, inclosos els no vigents*

* Cal tenir en compte que el botó ![](../../_media/esfera/mgac/b_oculta_novigents_a.png) canvia el nom quan se selecciona, i a la inversa.
