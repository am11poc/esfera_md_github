...
* [Què és](ccentre.md#que-es)
* [Com s'hi accedeix](ccentre.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](ccentre.md#quines-operacions-shi-poden-fer)

  + [Consultar](ccentre.md#consultar)
  + [Crear-ne un de nou fent una còpia](ccentre.md#crear-ne-un-de-nou-fent-una-copia)
  + [Crear-ne un a partir d’un currículum base](ccentre.md#crear-ne-un-a-partir-dun-curriculum-base)
  + [Modificar](ccentre.md#modificar)
  + [Esborrar](ccentre.md#esborrar)
  + [Cas particular de les ZER](ccentre.md#cas-particular-de-les-zer)
...
* [Consultar](ccentre.md#consultar) - veure la llista de currículums del centre.

* [Crear-ne un de nou fent una còpia](ccentre.md#crear-ne-un-de-nou-fent-una-copia) - L'aplicació fa una còpia d'un currículum existent, amb el mateix nom i continguts. Al codi hi afegeix la paraula "còpia". Després de copiar-lo, accedint a la funció [Modificar](ccentre.md#modificar), el programa permet canviar-ne el nom i modificar-ne els elements curriculars i les hores.

* [Crear-ne un a partir d’un currículum base](ccentre.md#crear-ne-un-a-partir-dun-curriculum-base) - Es crea un currículum nou, amb tots els elements curriculars que hi ha en un currículum base. En crear-lo s'hi ha de posar un codi, un nom, especificar si cal afegir o treure elements curriculars i, si és el cas, modificar-ne les hores.

* [Modificar](ccentre.md#modificar) - Aquesta funció permet canviar el nom del currículum i modificar-ne els elements curriculars i les hores.

* [Esborrar](ccentre.md#esborrar) - Permet esborrar els currículums del centre que ja no interessi mantenir[1)](ccentre.md#1). El programa controla que, per a cada ensenyament i nivell, hi hagi almenys un currículum del centre, i no deixa esborrar el currículum si aquest és el darrer que hi ha.

* [Cas particular de les ZER](ccentre.md#cas-particular-de-les-zer) - Totes les escoles d'una ZER comparteixen el Projecte educatiu. En aquest cas, la ZER defineix els currículums comuns per a tots els centres; posteriorment, cada centre pot fer-ne una petita adaptació.
...
**2)** Marcar la casella de selecció corresponent al currículum que es vol copiar [2)](ccentre.md#2)
...
**3)** Introduir les dades[3)](ccentre.md#3)
...
**2)** Marcar la casella corresponent al currículum que es vol esborrar. [4)](ccentre.md#4)
...
\* [Crear els currículums de la ZER i fer-ne la rèplica a les escoles](ccentre.md#crear-els-curriculums-de-la-zer-i-fer-ne-la-replica-a-les-escoles)  
\* [Crear els currículums del centre a les escoles de la ZER](ccentre.md#crear-els-curriculums-del-centre-a-les-escoles-de-la-zer)

#### Crear els currículums de la ZER i fer-ne la rèplica a les escoles

La ZER pot crear els currículums del centre amb totes les funcions, tal com s'ha descrit [anteriorment](ccentre.md#anteriorment).
...
* El comportament dels botons [Afegeix](ccentre.md#afegeix) i [Esborra](ccentre.md#esborra) és anàleg al que s'ha explicat abans.
...
* El funcionament del botó [Copiar](ccentre.md#copiar) és el mateix que s'ha explicat per copiar currículums en altres centres.
