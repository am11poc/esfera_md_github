...
* [Quines operacions s'hi poden fer](ccentre.md#quines-operacions-shi-poden-fer)
  ...
  + [Crear-ne un de nou fent una còpia](ccentre.md#crear-ne-un-de-nou-fent-una-còpia)
  + [Crear-ne un a partir d’un currículum base](ccentre.md#crear-ne-un-a-partir-dun-currículum-base)
...
\* [Crear els currículums de la ZER i fer-ne la rèplica a les escoles](ccentre.md#crear-els-currículums-de-la-zer-i-fer-ne-la-rèplica-a-les-escoles)  
\* [Crear els currículums del centre a les escoles de la ZER](ccentre.md#crear-els-currículums-del-centre-a-les-escoles-de-la-zer)
