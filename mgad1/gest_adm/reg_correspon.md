...
* [Què és](reg_correspon.md#què-és)
* [Com s’hi accedeix](reg_correspon.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](reg_correspon.md#quines-operacions-shi-poden-fer)

  + [Exercicis](reg_correspon.md#exercicis)
  + [Contactes](reg_correspon.md#contactes)
  + [Temes](reg_correspon.md#temes)
  + [Registres d'entrada](reg_correspon.md#registres-dentrada)
  + [Registres de sortida](reg_correspon.md#registres-de-sortida)
  + [Extracció dels moviments](reg_correspon.md#extracció-dels-moviments)
...
![](../../_media/esfera/mgac/gadmin/reg_corres_01.png)*Imatge 1 - Accés a Registre de correspondència*
...
![](../../_media/esfera/mgac/gadmin/reg_corres_02.png)*Imatge 2 - Pantalla de l'opció Exercicis*
  
Per crear un nou exercici cal clicar al botó ![](../../_media/esfera/mgac/b_afegeix.png), i definir-lo a la finestra corresponent:
  
![](../../_media/esfera/mgac/gadmin/reg_corres_03.png)*Imatge 3 - Finestra per crear un exercici*
  
L'exercici que s'hagi creat es mostrarà a la llista d'exercicis:
  
![](../../_media/esfera/mgac/gadmin/reg_corres_04.png)*Imatge 4 - Exercicis*
...
![](../../_media/esfera/mgac/gadmin/reg_corres_05.png)*Imatge 5 - Pantalla per afegir un contacte*
  
Per crear un nou contacte cal clicar al botó ![](../../_media/esfera/mgac/b_afegeix.png), i definir-lo a la finestra corresponent:
  
![](../../_media/esfera/mgac/gadmin/reg_corres_06.png)*Imatge 6 - Finestra per crear un contacte*
...
![](../../_media/esfera/mgac/gadmin/reg_corres_07.png)*Imatge 7 - Llista de contactes*
  
Els contactes creats no es poden eliminar, però sí que es poden donar de baixa; d'aquesta manera ja no es podran utilitzar.
  
Per fer-ho cal seleccionar el contacte o contactes que es desitgi i prémer el botó ![](../../_media/esfera/mgac/b_baixa.png).
  
El botó ![](../../_media/esfera/mgac/b_oculta_novigents.png) amaga els contactes donats de baixa.
  
Aquest botó alterna amb ![](../../_media/esfera/mgac/boto_mostrar_novigents.png), que els farà visibles novament.
...
![](../../_media/esfera/mgac/gadmin/reg_corres_08.png)*Imatge 8 - Temes*
  
Per crear un tema nou cal clicar al botó ![](../../_media/esfera/mgac/b_afegeix.png), i definir-lo a la finestra corresponent:
  
![](../../_media/esfera/mgac/gadmin/reg_corres_09.png)*Imatge 9 - Crear un tema*
  
El tema que s'hagi creat es mostrarà a la llista de temes:
  
![](../../_media/esfera/mgac/gadmin/reg_corres_10.png)*Imatge 10 - Llista de temes*
...
![](../../_media/esfera/mgac/b_baixa.png).
...
Aquesta graella mostra una mínima informació de cada document. Al final de cada registre hi ha la icona ![](../../_media/esfera/mgac/i_accedeix.png), que permet accedir al detall del registre.
  
  
![](../../_media/esfera/mgac/gadmin/reg_corres_11.png)*Imatge 11 - Pantalla per enregistrar entrades*
  
Per enregistrar un nou document d'entrada s'ha de clicar al botó ![](../../_media/esfera/mgac/b_afegeix.png).
A continuació, a la finestra modal, s'han d'emplenar les dades del document:
![](../../_media/esfera/mgac/gadmin/reg_corres_12.png)*Imatge 12 - Registre d'entrada d'un document*
...
Per acabar s'ha de clicar al botó ![](../../_media/esfera/mgac/b_desa.png).
  
El nou registre es mostrarà a la llista de documents d'entrada.
  
Els registres de documents no es poden esborrar, però és possible anul·lar-los. Per fer-ho cal seleccionar el registre i prémer el botó ![](../../_media/esfera/mgac/b_anulla.png).
El botó ![](../../_media/esfera/mgac/b_visualitza_anullats.png) mostrarà a la pantalla els registres anul·lats. Aquest botó alterna amb l'opció ![](../../_media/esfera/mgac/b_oculta_anullats.png), que amaga els registres anul·lats.
...
![](../../_media/esfera/mgac/gadmin/reg_corres_13.png)*Imatge 13 - Registre de sortida d'un document*
