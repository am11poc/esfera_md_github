...
* [Què són](g_zer.md#que-son)
* [Com s’hi accedeix](g_zer.md#com-shi-accedeix)
* [Quines operacions s'hi poden fer](g_zer.md#quines-operacions-shi-poden-fer)

  + [Crear un grup ZER](g_zer.md#crear-un-grup-zer)
  + [Modificar un grup ZER](g_zer.md#modificar-un-grup-zer)
  + [Esborrar un grup ZER](g_zer.md#esborrar-un-grup-zer)
...
* [Crear un grup ZER](g_zer.md#crear-un-grup-zer) - **Només des de la ZER**. Permet crear nous grups ZER
* [Modificar un grup ZER](g_zer.md#modificar-un-grup-zer) - Per veure la composició del grup, és a dir, la relació d'alumnes i personal i modificar-lo, si és el cas.
...
* [Esborrar un grup ZER](g_zer.md#esborrar-un-grup-zer) - **Només des de la ZER** El programa permet esborrar un grup ZER sempre que no tingui alumnes, personal ni responsable.
...
* [Identificar el grup](g_zer.md#identificar-el-grup)
* [Afegir/treure alumnes del grup](g_zer.md#afegirtreure-alumnes-del-grup)
* [Afegir/treure personal al grup](g_zer.md#afegirtreure-personal-al-grup)
