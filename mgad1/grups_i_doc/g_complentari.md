...
* [Quines operacions s'hi poden fer](g_complentari.md#quines-operacions-shi-poden-fer)
  ...
  + [Crear un grup complementari](g_complentari.md#crear-un-grup-complementari)
  + [Esborrar un grup complementari](g_complentari.md#esborrar-un-grup-complementari)
  + [Modificar un grup complementari](g_complentari.md#modificar-un-grup-complementari)
...
* [Crear un grup complementari](g_complentari.md#crear-un-grup-complementari) - Per crear nous grups complementaris.
* [Modificar un grup complementari](g_complentari.md#modificar-un-grup-complementari) - Per veure la composició del grup, és a dir, la relació d'alumnes i personal i modificar-lo, si és el cas.
* [Esborrar un grup complementari](g_complentari.md#esborrar-un-grup-complementari) - El programa permet esborrar un grup complementari sempre que no tingui alumnes, personal ni responsable.
...
* [Identificar el grup](g_complentari.md#identificar-el-grup)
* [Afegir/treure alumnes del grup](g_complentari.md#afegirtreure-alumnes-del-grup)
* [Afegir/treure personal al grup](g_complentari.md#afegirtreure-personal-al-grup)
